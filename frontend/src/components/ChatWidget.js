...
const ChatWidget = ({ user, externalOpen, onExternalClose }) => {
  ...
  // Chat penceresi
  return (
    <div className="fixed bottom-[88px] md:bottom-6 right-4 z-50 w-[22rem] md:w-96 max-w-[calc(100vw-2rem)] h-[460px] md:h-[580px] max-h-[calc(100vh-10rem)] md:max-h-[calc(100vh-4rem)] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200">
      {/* Header */}
