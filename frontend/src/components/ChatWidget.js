...
const ChatWidget = ({ user, externalOpen, onExternalClose }) => {
  ...
  // Chat penceresi
  return (
    <div className="fixed bottom-24 md:bottom-6 right-4 z-50 w-[22rem] md:w-96 max-w-[calc(100vw-2rem)] h-[520px] md:h-[600px] max-h-[calc(100vh-7rem)] md:max-h-[calc(100vh-4rem)] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200">
      {/* Header */}
